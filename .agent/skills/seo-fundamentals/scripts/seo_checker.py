...
def check_page(file_path: Path) -> dict:
    ...
    # Detect if this is a layout/template file (has Head component from frameworks, or raw <head>)
    is_layout = bool(re.search(r'<Head\s*>', content) or re.search(r'<head\b', content.lower()))
