    ...
    return (
        <div className="space-y-6 mt-6 pb-20">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="medicamento" className="space-y-6 mt-8">
                    {renderFilteredItems()}
                </TabsContent>
                <TabsContent value="vitamina" className="space-y-6 mt-8">
                    {renderFilteredItems()}
                </TabsContent>
                <TabsContent value="suplemento" className="space-y-6 mt-8">
                    {renderFilteredItems()}
                </TabsContent>
            </Tabs>
        </div>
